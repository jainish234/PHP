...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/jb-digitals/home" target="_blank">Google Site</a></li>
                    ...
                    <li class="list-group-item"><a href="https://github.com/jainish234/" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                <div id="header">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h1>Barbhaya Jainish</h1>
                            </div>
                            <div class="col-md-6">
                                <img src="logo.png" alt="Logo" width="60" class="float-right" height="80">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    ...
                    <p><br><?php echo "$fetch_my_data[2]"; ?></p>
                        <!--<li>C</li>
                        <li>PHP</li>
                        <li>HTML</li>
                        <li>GAMING SKILL</li>
                        <li>READING & WRITTING</li>-->
                    </div>
                    </div>
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/jainish234/PHP/tree/main/Task-1" target="_blank">Task-1</a></button>
                            <button class="sunset-orange-button gradient-button"><a href="https://github.com/jainish234/PHP/tree/main/Task-2" target="_blank">Task-2</a></button>
                            <button class="spring-green-button gradient-button"><a href="https://github.com/jainish234/PHP/tree/main/Task-3" target="_blank">Task-3</a></button>
    ...
    <div id="footer">
        <h3>Footer Title</h3>
        <img src="logo.png" alt="Footer Logo" width="60" height="80">
    </div>
